...
try{
	...
	rs.next();
	out.println("<td></td><td><b>Over all</b></td><td>");%><%=rs.getString(1)%></td><td><%=rs.getString(2)%></td><td><%=rs.getString(3)%></td><td><%=Math.round((Float.parseFloat(rs.getString(4))*100))/100%></td></tr></table></td>
	<%}
	else
	{
