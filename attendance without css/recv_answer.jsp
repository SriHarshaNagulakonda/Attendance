...
rs=st.executeQuery("select s_id,name from courses natural join student where f_id='"+fid+"' and c_id='"+aid+"' and s_id not in (select s_id from answer where a_id='"+aid+"' and s_id)");
while(rs.next()){%>
<table  align="center">
	<tr>
