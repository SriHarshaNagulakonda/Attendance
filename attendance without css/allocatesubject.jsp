	...
	catch(SQLException se)
{
	...
	{
	%>
	<p align="center"><%="This faculty has already allocated for 3 subjects"%></p>
	<%
}
else
{
...
{
	%>
<p align="center"><%="Subjects are successfully allocated"%></p><br>
	<%
}
if(count1<3 &&flag==0)
{
	%>
	<p align="center"><%="Courses are not available for allocation"%></p>
	<%
}
%>
<p align="center"><%="The Courses Allocated For The Faculty Are:"%></p><br>
<table align="center">
		<tr>
			<td>Course_Id</td>
			<td>Course Name</td>
