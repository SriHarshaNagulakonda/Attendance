...
try{
	...
	<%}%>
</select></td><td><input type="submit" name="show" value="Get Assignments" class="button button5"></td></tr></form>
<%
...
<tr>
	...
	<%}%>
</select></td><tr><td></td><td><input type="submit" name="show" value="Show Assignment" class="button button5"></td></tr></tr>
		<%
}
	}
	catch(Exception e)
